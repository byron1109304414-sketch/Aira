...
// 1. CONSTANTS
// ================================================================
const APP_VERSION='5.2.1-stable';
...
// ================================================================
// 2.5 V5 APP CORE — workspace + evidence schema (Phase 1 skeleton)
// ----------------------------------------------------------------
// V5 introduces two workspaces (self | coach). This block only
// provides the global container, storage key and schema descriptor.
// No UI, no routing change, no data shape change. V4.1.0 data is
// implicitly owned by workspace 'self' (see App.load first-boot).
// ================================================================
const WORKSPACE_SELF='self';
const WORKSPACE_COACH='coach';
const WORKSPACE_KEY='aira_app_v5_workspace';

const App={
  workspace:WORKSPACE_SELF,
  WORKSPACES:Object.freeze([WORKSPACE_SELF,WORKSPACE_COACH]),
  _onChange:null,
  load(){
    try{
      const raw=localStorage.getItem(WORKSPACE_KEY);
      if(raw===WORKSPACE_SELF||raw===WORKSPACE_COACH){
        this.workspace=raw;
      }else{
        this.workspace=WORKSPACE_SELF;
        this.save();
      }
    }catch(e){console.warn('App.load failed',e);this.workspace=WORKSPACE_SELF}
    return this.workspace;
  },
  save(){try{localStorage.setItem(WORKSPACE_KEY,this.workspace)}catch(e){console.warn('App.save failed',e)}},
  get(){return this.workspace},
  set(ws){
    if(ws!==WORKSPACE_SELF&&ws!==WORKSPACE_COACH)return false;
    if(this.workspace===ws)return true;
    this.workspace=ws;
    this.save();
    if(typeof this._onChange==='function'){
      try{this._onChange(ws)}catch(e){console.warn('workspace onChange error',e)}
    }
    return true;
  },
  isSelf(){return this.workspace===WORKSPACE_SELF},
  isCoach(){return this.workspace===WORKSPACE_COACH},
...
const EVIDENCE_SCHEMA=Object.freeze({
  exercise_meta_fields:Object.freeze([
    ...
    'goal_tags','skill_level','fatigue_cost',
    'recommended_rep_range','recommended_set_range','recommended_frequency',
    'rest_guidance','swap_candidates','contraindication_note',
    'coaching_cues','evidence_ref_ids'
  ]),
  program_meta_fields:Object.freeze([
    'split_type','primary_goal','frequency_recommendation','duration_range',
    'volume_profile','fatigue_profile','target_population',
    'evidence_ref_ids','rationale_summary'
  ]),
...
const EXERCISE_METADATA=Object.freeze({
  ...
  incline_dumbbell_press:Object.freeze({
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['flat_dumbbell_press','barbell_bench_press','incline_machine_press','smith_incline_press','machine_chest_press']),
    contraindication_note:'肩前側不適者降傾角或改器械。',
    coaching_cues:Object.freeze(['椅背 30–45 度','肩胛下沉後收','啞鈴下至胸上緣','避免頂點啞鈴相撞']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','schoenfeld_volume_2017'])
  }),
  flat_dumbbell_press:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid','triceps_brachii']),
    movement_pattern:'horizontal_push',
    equipment:'Dumbbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['barbell_bench_press','machine_chest_press','incline_dumbbell_press','smith_bench_press','push_up']),
    contraindication_note:'肩關節急性期降負荷或改器械。',
    coaching_cues:Object.freeze(['肩胛後收下壓','啞鈴軌跡略內收','下至胸側外緣','頂點勿鎖死']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','schoenfeld_volume_2017'])
  }),
  machine_chest_press:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid','triceps_brachii']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['barbell_bench_press','flat_dumbbell_press','smith_bench_press','chest_press_neutral','incline_machine_press']),
    contraindication_note:'椅高設定使握把位於胸中段，肩不適者改中立握。',
    coaching_cues:Object.freeze(['椅高對齊乳頭線','背貼椅墊','推到伸直但不鎖死','離心控制回位']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','schoenfeld_volume_2017'])
  }),
  incline_machine_press:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid','triceps_brachii']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['incline_dumbbell_press','smith_incline_press','machine_chest_press','barbell_bench_press']),
    contraindication_note:'肩夾擠者避免推至完全鎖死。',
    coaching_cues:Object.freeze(['椅背上斜 30–45 度','握把對胸上緣','推至伸直不鎖','控制離心']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  smith_bench_press:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid','triceps_brachii']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['barbell_bench_press','machine_chest_press','flat_dumbbell_press','smith_incline_press']),
    contraindication_note:'固定軌跡可能對肩敏感者不友善，疼痛即停。',
    coaching_cues:Object.freeze(['椅子位置使槓對齊胸下緣','肩胛後收','下槓輕碰胸','腳踏穩定']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  smith_incline_press:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid','triceps_brachii']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    fatigue_cost:'moderate',
    recommended_rep_range:Object.freeze([6,12]),
    recommended_set_range:Object.freeze([3,4]),
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['incline_dumbbell_press','incline_machine_press','smith_bench_press','barbell_bench_press']),
    contraindication_note:'椅背角度過陡肩負擔增大，建議 30–45 度。',
    coaching_cues:Object.freeze(['椅背 30–45 度','槓對齊胸上緣','肩胛下沉','緩慢離心']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  chest_press_neutral:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid','triceps_brachii']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['machine_chest_press','flat_dumbbell_press','incline_dumbbell_press','incline_machine_press']),
    contraindication_note:'中立握對肩前側較友善，急性期仍需降幅度。',
    coaching_cues:Object.freeze(['握把中立','肩胛下沉後收','推至伸直不鎖','離心控制']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  cable_fly:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Cable',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([10,15]),
    recommended_set_range:Object.freeze([3,4]),
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['machine_fly','pec_deck_fly','high_to_low_cable_fly','single_arm_high_to_low_cable_fly']),
    contraindication_note:'肩前側不適者縮小外展幅度。',
    coaching_cues:Object.freeze(['手肘微彎固定','肩胛下沉','畫弧線夾胸','頂點略停收縮']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  machine_fly:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['pec_deck_fly','cable_fly','high_to_low_cable_fly']),
    contraindication_note:'起始過度外展者肩前側易痛，縮小起始幅度。',
    coaching_cues:Object.freeze(['椅高對胸中段','手肘略彎','向中線夾','頂點略停']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  pec_deck_fly:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['machine_fly','cable_fly']),
    contraindication_note:'肩前側不適者限制起始外展。',
    coaching_cues:Object.freeze(['肩胛貼椅背','前臂貼墊','向中線夾','頂點略停']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  machine_shoulder_press:Object.freeze({
    primary_muscle:'anterior_deltoid',
    secondary_muscles:Object.freeze(['triceps_brachii','upper_trapezius']),
    movement_pattern:'vertical_push',
    equipment:'Machine',
    goal_tags:Object.freeze(['hypertrophy','general_health']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['overhead_press','dumbbell_shoulder_press','seated_machine_shoulder_press','seated_dumbbell_shoulder_press']),
    contraindication_note:'肩夾擠者降幅度或改中立握。',
    coaching_cues:Object.freeze(['背貼椅墊','握把略寬於肩','推到伸直不鎖死','穩定下放']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  dumbbell_shoulder_press:Object.freeze({
    primary_muscle:'anterior_deltoid',
    secondary_muscles:Object.freeze(['triceps_brachii','upper_trapezius','serratus_anterior']),
    movement_pattern:'vertical_push',
    equipment:'Dumbbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['overhead_press','seated_dumbbell_shoulder_press','machine_shoulder_press','arnold_press']),
    contraindication_note:'肩夾擠者改中立握或降幅度。',
    coaching_cues:Object.freeze(['啞鈴起始略低於耳','核心收緊避免腰過伸','推到頂點略停','避免鎖死肘']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  seated_dumbbell_shoulder_press:Object.freeze({
    primary_muscle:'anterior_deltoid',
    secondary_muscles:Object.freeze(['triceps_brachii','upper_trapezius']),
    movement_pattern:'vertical_push',
    equipment:'Dumbbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['dumbbell_shoulder_press','overhead_press','machine_shoulder_press','seated_machine_shoulder_press','arnold_press']),
    contraindication_note:'椅背垂直避免腰過伸，下背敏感者設定椅背略後傾。',
    coaching_cues:Object.freeze(['背貼椅墊','啞鈴起始對耳','推至伸直不鎖','控制離心']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  seated_machine_shoulder_press:Object.freeze({
    primary_muscle:'anterior_deltoid',
    secondary_muscles:Object.freeze(['triceps_brachii','upper_trapezius']),
    movement_pattern:'vertical_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['machine_shoulder_press','seated_dumbbell_shoulder_press','overhead_press','smith_shoulder_press']),
    contraindication_note:'固定軌跡對部份人肩前側壓力大，疼痛即停。',
    coaching_cues:Object.freeze(['背貼椅墊','握把對耳','推至伸直不鎖','穩定控制']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  smith_shoulder_press:Object.freeze({
    primary_muscle:'anterior_deltoid',
    secondary_muscles:Object.freeze(['triceps_brachii','upper_trapezius']),
    movement_pattern:'vertical_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['overhead_press','machine_shoulder_press','seated_dumbbell_shoulder_press']),
    contraindication_note:'固定軌跡對肩夾擠者仍有風險，降幅度或改其他。',
    coaching_cues:Object.freeze(['椅背近乎垂直','握距略寬於肩','下至耳高','推至伸直不鎖']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  lateral_raise:Object.freeze({
    primary_muscle:'lateral_deltoid',
    secondary_muscles:Object.freeze(['upper_trapezius','supraspinatus']),
    movement_pattern:'isolation',
    equipment:'Dumbbell',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([10,20]),
    recommended_set_range:Object.freeze([3,5]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['cable_lateral_raise','upright_row','front_raise']),
    contraindication_note:'肩夾擠者降負荷並避免過高，手肘略低於手腕。',
    coaching_cues:Object.freeze(['手肘微彎','啞鈴抬至肩高','小拇指略高於大拇指','控制下放']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  cable_lateral_raise:Object.freeze({
    primary_muscle:'lateral_deltoid',
    secondary_muscles:Object.freeze(['upper_trapezius','supraspinatus']),
    movement_pattern:'isolation',
    equipment:'Cable',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['lateral_raise','upright_row','front_raise']),
    contraindication_note:'肩夾擠者降負荷並避免過高。',
    coaching_cues:Object.freeze(['站姿身側站位','手肘微彎','抬至肩高','離心完整控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  front_raise:Object.freeze({
    primary_muscle:'anterior_deltoid',
    secondary_muscles:Object.freeze(['upper_trapezius','pectoralis_major']),
    movement_pattern:'isolation',
    equipment:'Dumbbell',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([10,15]),
    recommended_set_range:Object.freeze([2,4]),
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['lateral_raise','cable_lateral_raise','upright_row']),
    contraindication_note:'肩前側已高量訓練者避免額外累加。',
    coaching_cues:Object.freeze(['核心穩定不擺','抬至肩高','手肘微彎','控制下放']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  triceps_pushdown:Object.freeze({
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['rope_pushdown','straight_bar_pushdown','overhead_triceps_extension','lying_triceps_extension']),
    contraindication_note:'肘關節疼痛者降負荷或縮幅度。',
    coaching_cues:Object.freeze(['肘夾身側固定','下壓至伸直','頂點略停','離心控制回位']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  rope_pushdown:Object.freeze({
    primary_muscle:'triceps_brachii',
    secondary_muscles:Object.freeze([]),
    movement_pattern:'isolation',
    equipment:'Cable',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['triceps_pushdown','straight_bar_pushdown','overhead_triceps_extension']),
    contraindication_note:'肘關節疼痛者降負荷。',
    coaching_cues:Object.freeze(['肘夾身側','底部略外旋分繩','頂點完整收縮','控制回位']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  straight_bar_pushdown:Object.freeze({
    primary_muscle:'triceps_brachii',
    secondary_muscles:Object.freeze([]),
    movement_pattern:'isolation',
    equipment:'Cable',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['triceps_pushdown','rope_pushdown','lying_triceps_extension']),
    contraindication_note:'手腕不適者換繩索或改中立握。',
    coaching_cues:Object.freeze(['肘夾身側','握把平握','下壓至伸直','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  overhead_triceps_extension:Object.freeze({
    primary_muscle:'triceps_brachii',
    secondary_muscles:Object.freeze([]),
    movement_pattern:'isolation',
    equipment:'Cable',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['lying_triceps_extension','rope_pushdown','triceps_pushdown','skull_crusher']),
    contraindication_note:'肩前側不適者降伸展幅度或換下壓類。',
    coaching_cues:Object.freeze(['肘貼耳固定','完整伸展至頭後','頂點收縮伸直','控制離心']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  lying_triceps_extension:Object.freeze({
    primary_muscle:'triceps_brachii',
    secondary_muscles:Object.freeze([]),
    movement_pattern:'isolation',
    equipment:'Barbell',
    ...
    skill_level:'intermediate',
    fatigue_cost:'moderate',
    recommended_rep_range:Object.freeze([8,12]),
    recommended_set_range:Object.freeze([3,4]),
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['skull_crusher','overhead_triceps_extension','rope_pushdown','triceps_pushdown']),
    contraindication_note:'肘關節疼痛者改下壓類。',
    coaching_cues:Object.freeze(['上臂垂直地面','肘位置固定','下至額頭上緣','伸直至頂']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  assisted_dip:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['triceps_brachii','anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'75–120 秒',
    swap_candidates:Object.freeze(['weighted_dip','chest_dip','assisted_chest_dip','push_up','machine_chest_press']),
    contraindication_note:'肩前側痛或鎖骨遠端不適者不建議，改器械胸推。',
    coaching_cues:Object.freeze(['前傾軀幹針對胸','下至肩略低於肘','避免鎖死','控制下放']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  push_up:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid','triceps_brachii','serratus_anterior','rectus_abdominis']),
    movement_pattern:'horizontal_push',
    equipment:'Bodyweight',
    goal_tags:Object.freeze(['general_health','hypertrophy']),
    skill_level:'beginner',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([8,20]),
    recommended_set_range:Object.freeze([3,5]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['decline_push_up','barbell_bench_press','flat_dumbbell_press','machine_chest_press','assisted_dip']),
    contraindication_note:'手腕痛者用推舉柄或改器械。',
    coaching_cues:Object.freeze(['身體一直線','手肘夾角 45 度','胸下至拳頭高','核心全程收緊']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  decline_push_up:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid','triceps_brachii','serratus_anterior']),
    movement_pattern:'horizontal_push',
    equipment:'Bodyweight',
    goal_tags:Object.freeze(['hypertrophy','general_health']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'75–120 秒',
    swap_candidates:Object.freeze(['push_up','incline_dumbbell_press','barbell_bench_press','weighted_dip']),
    contraindication_note:'手腕痛者改器械。',
    coaching_cues:Object.freeze(['腳抬起 30–45 cm','身體一直線','控制下至胸觸地','核心收緊']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  decline_barbell_bench_press:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['triceps_brachii','anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Barbell',
    ...
    recommended_frequency:'每週 1 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['barbell_bench_press','decline_dumbbell_press','decline_machine_press','decline_smith_press']),
    contraindication_note:'下斜位下背受壓者改平板或器械。',
    coaching_cues:Object.freeze(['腳固定避免滑動','下至胸下緣','推至伸直不鎖','肩胛收穩']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  decline_dumbbell_press:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['triceps_brachii','anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Dumbbell',
    ...
    recommended_frequency:'每週 1 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['decline_barbell_bench_press','flat_dumbbell_press','decline_machine_press']),
    contraindication_note:'頭部充血不適者改平板。',
    coaching_cues:Object.freeze(['腳固定','下至胸下緣','手肘夾角適中','控制離心']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  decline_smith_press:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['triceps_brachii','anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['decline_barbell_bench_press','decline_machine_press','smith_bench_press']),
    contraindication_note:'下斜頭部充血不適者改平板。',
    coaching_cues:Object.freeze(['椅位對齊胸下緣','下槓輕碰胸','控制伸直','腳踏穩']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  decline_machine_press:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['triceps_brachii','anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['decline_dumbbell_press','decline_barbell_bench_press','machine_chest_press','decline_smith_press']),
    contraindication_note:'頭部充血不適者改平板器械。',
    coaching_cues:Object.freeze(['椅高對胸下緣','推至伸直不鎖','離心控制','穩定腳踏']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  high_to_low_cable_fly:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Cable',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['cable_fly','single_arm_high_to_low_cable_fly','machine_fly','pec_deck_fly']),
    contraindication_note:'肩前側不適者縮小外展幅度。',
    coaching_cues:Object.freeze(['站姿略前傾','手肘微彎','畫弧夾至肚臍前','頂點略停']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  single_arm_high_to_low_cable_fly:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['anterior_deltoid','obliques']),
    movement_pattern:'horizontal_push',
    equipment:'Cable',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'intermediate',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['high_to_low_cable_fly','cable_fly','machine_fly']),
    contraindication_note:'核心抗旋轉弱者降負荷。',
    coaching_cues:Object.freeze(['單側站位','手肘微彎','畫弧至身體中線','穩住核心不轉']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  chest_dip:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['triceps_brachii','anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Bodyweight',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['weighted_dip','assisted_chest_dip','push_up','decline_push_up','machine_chest_press']),
    contraindication_note:'肩前側痛或鎖骨遠端不適者不建議。',
    coaching_cues:Object.freeze(['軀幹前傾 30 度','下至肩略低於肘','頂點略收胸','避免鎖死']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  assisted_chest_dip:Object.freeze({
    primary_muscle:'pectoralis_major',
    secondary_muscles:Object.freeze(['triceps_brachii','anterior_deltoid']),
    movement_pattern:'horizontal_push',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'75–120 秒',
    swap_candidates:Object.freeze(['chest_dip','assisted_dip','push_up','machine_chest_press']),
    contraindication_note:'肩前側痛者改器械胸推。',
    coaching_cues:Object.freeze(['膝跪助力墊','軀幹前傾','下至肩略低於肘','控制離心']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  arnold_press:Object.freeze({
    primary_muscle:'anterior_deltoid',
    secondary_muscles:Object.freeze(['lateral_deltoid','triceps_brachii','upper_trapezius']),
    movement_pattern:'vertical_push',
    equipment:'Dumbbell',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'intermediate',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['dumbbell_shoulder_press','seated_dumbbell_shoulder_press','overhead_press','machine_shoulder_press']),
    contraindication_note:'肩前側疼痛者改中立握肩推。',
    coaching_cues:Object.freeze(['起始反握對面部','推起同時外旋','頂點手心朝前','離心反向控制']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  upright_row:Object.freeze({
    primary_muscle:'lateral_deltoid',
    secondary_muscles:Object.freeze(['upper_trapezius','biceps_brachii']),
    movement_pattern:'vertical_pull',
    equipment:'Barbell',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['lateral_raise','cable_lateral_raise','front_raise']),
    contraindication_note:'肩夾擠者將槓抬至肩下或改側平舉。',
    coaching_cues:Object.freeze(['握距略寬於肩','肘主導','抬至胸上緣停','控制下放']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  skull_crusher:Object.freeze({
    primary_muscle:'triceps_brachii',
    secondary_muscles:Object.freeze([]),
    movement_pattern:'isolation',
    equipment:'Barbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['lying_triceps_extension','overhead_triceps_extension','rope_pushdown','triceps_pushdown']),
    contraindication_note:'肘關節疼痛者降負荷或改下壓類。',
    coaching_cues:Object.freeze(['上臂垂直略後傾','肘位置固定','下至額頭上方','伸直至頂']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  assisted_pull_up:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['biceps_brachii','rhomboids','trapezius','teres_major']),
    movement_pattern:'vertical_pull',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'75–120 秒',
    swap_candidates:Object.freeze(['pull_up','lat_pulldown','close_grip_lat_pulldown','wide_grip_lat_pulldown']),
    contraindication_note:'肩關節彈響者改中立握或下拉。',
    coaching_cues:Object.freeze(['膝跪助力墊','肩胛先下沉','下巴過槓','控制離心']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  wide_grip_lat_pulldown:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['biceps_brachii','rhomboids','teres_major']),
    movement_pattern:'vertical_pull',
    equipment:'Cable',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['lat_pulldown','pull_up','close_grip_lat_pulldown','reverse_grip_lat_pulldown']),
    contraindication_note:'肩夾擠者縮小握距或改窄握。',
    coaching_cues:Object.freeze(['握距略寬於肩','肩胛先下沉','拉桿至鎖骨','離心緩慢']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  close_grip_lat_pulldown:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['biceps_brachii','rhomboids','teres_major']),
    movement_pattern:'vertical_pull',
    equipment:'Cable',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['lat_pulldown','wide_grip_lat_pulldown','reverse_grip_lat_pulldown','pull_up']),
    contraindication_note:'肘關節不適者換中立握 V 把。',
    coaching_cues:Object.freeze(['中立握 V 把','肩胛下沉','拉至胸上緣','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  reverse_grip_lat_pulldown:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['biceps_brachii','rhomboids']),
    movement_pattern:'vertical_pull',
    equipment:'Cable',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['lat_pulldown','close_grip_lat_pulldown','pull_up','assisted_pull_up']),
    contraindication_note:'肘肌腱炎者降負荷。',
    coaching_cues:Object.freeze(['握距肩寬反握','肩胛先下沉','拉至鎖骨上緣','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  straight_arm_pulldown:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['teres_major','triceps_brachii']),
    movement_pattern:'isolation',
    equipment:'Cable',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['lat_pulldown','wide_grip_lat_pulldown','seated_cable_row']),
    contraindication_note:'肩前側不適者降幅度。',
    coaching_cues:Object.freeze(['手臂伸直微彎','肩胛下沉','下壓至大腿前','頂點略停']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  chest_supported_row:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['rhomboids','trapezius','posterior_deltoid','biceps_brachii']),
    movement_pattern:'horizontal_pull',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['barbell_row','cable_row','seated_cable_row','t_bar_row','machine_row']),
    contraindication_note:'下背痛者最優先選擇（有胸托）。',
    coaching_cues:Object.freeze(['胸貼墊','肩胛後收','肘往後夾','頂點略停']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','schoenfeld_volume_2017'])
  }),
  seated_cable_row:Object.freeze({
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['cable_row','chest_supported_row','barbell_row','machine_row']),
    contraindication_note:'下背痛者改胸托划船。',
    coaching_cues:Object.freeze(['坐姿微挺胸','肩胛先後收','肘拉至腹側','控制回位']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','schoenfeld_volume_2017'])
  }),
  cable_row:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['rhomboids','trapezius','posterior_deltoid','biceps_brachii']),
    movement_pattern:'horizontal_pull',
    equipment:'Cable',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['seated_cable_row','chest_supported_row','barbell_row','machine_row']),
    contraindication_note:'下背痛者改胸托划船。',
    coaching_cues:Object.freeze(['微挺胸','肩胛先後收','肘拉至腹側','控制回位']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  t_bar_row:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['rhomboids','trapezius','posterior_deltoid','biceps_brachii']),
    movement_pattern:'horizontal_pull',
    equipment:'Barbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['barbell_row','pendlay_row','meadows_row','chest_supported_row','cable_row']),
    contraindication_note:'下背痛者改胸托或坐姿划船。',
    coaching_cues:Object.freeze(['髖鉸鏈到位','背部中立','肘夾身側往後','避免下背代償']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','schoenfeld_volume_2017'])
  }),
  single_arm_dumbbell_row:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['rhomboids','trapezius','posterior_deltoid','biceps_brachii']),
    movement_pattern:'horizontal_pull',
    equipment:'Dumbbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['barbell_row','chest_supported_row','cable_row','t_bar_row']),
    contraindication_note:'下背痛者選胸托划船取代。',
    coaching_cues:Object.freeze(['膝手支撐平板','背平行地面','肘拉向髖部','控制離心']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  machine_row:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['rhomboids','trapezius','posterior_deltoid','biceps_brachii']),
    movement_pattern:'horizontal_pull',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['chest_supported_row','seated_cable_row','cable_row','barbell_row']),
    contraindication_note:'肩夾擠者改中立握。',
    coaching_cues:Object.freeze(['胸貼墊','肩胛後收','肘拉向腰側','控制回位']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  face_pull:Object.freeze({
    primary_muscle:'posterior_deltoid',
    secondary_muscles:Object.freeze(['rhomboids','trapezius','rotator_cuff']),
    movement_pattern:'horizontal_pull',
    equipment:'Cable',
    goal_tags:Object.freeze(['general_health','hypertrophy']),
    skill_level:'beginner',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([12,20]),
    recommended_set_range:Object.freeze([3,4]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['rear_delt_fly','reverse_pec_deck','reverse_cable_fly']),
    contraindication_note:'肩前鬆弛者避免過度外旋。',
    coaching_cues:Object.freeze(['站姿雙手反握繩','肘高於肩','拉至太陽穴外','外旋至繩分開']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  rear_delt_fly:Object.freeze({
    primary_muscle:'posterior_deltoid',
    secondary_muscles:Object.freeze(['rhomboids','trapezius']),
    movement_pattern:'isolation',
    equipment:'Machine',
    goal_tags:Object.freeze(['hypertrophy','general_health']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['reverse_pec_deck','face_pull','reverse_cable_fly']),
    contraindication_note:'肩前側超負荷者將姿勢微調。',
    coaching_cues:Object.freeze(['手肘微彎','向後畫弧','頂點略停','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  reverse_pec_deck:Object.freeze({
    primary_muscle:'posterior_deltoid',
    secondary_muscles:Object.freeze(['rhomboids','trapezius']),
    movement_pattern:'isolation',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['rear_delt_fly','face_pull','reverse_cable_fly']),
    contraindication_note:'肩前鬆弛者避免握把過於外展。',
    coaching_cues:Object.freeze(['胸貼墊','手肘微彎','向後畫弧','頂點略停']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  barbell_curl:Object.freeze({
    primary_muscle:'biceps_brachii',
    secondary_muscles:Object.freeze(['brachialis','forearm_flexors']),
    movement_pattern:'isolation',
    equipment:'Barbell',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['ez_bar_curl','cable_curl','preacher_curl','incline_dumbbell_curl','hammer_curl']),
    contraindication_note:'手腕疼痛者改 EZ 槓。',
    coaching_cues:Object.freeze(['肘夾身側','反握槓鈴','彎至頂點略停','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  ez_bar_curl:Object.freeze({
    primary_muscle:'biceps_brachii',
    secondary_muscles:Object.freeze(['brachialis','forearm_flexors']),
    movement_pattern:'isolation',
    equipment:'Barbell',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['barbell_curl','cable_curl','preacher_curl','incline_dumbbell_curl']),
    contraindication_note:'手肘疼痛者降負荷。',
    coaching_cues:Object.freeze(['肘夾身側','半反握角度','彎至頂點收縮','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  cable_curl:Object.freeze({
    primary_muscle:'biceps_brachii',
    secondary_muscles:Object.freeze(['brachialis','forearm_flexors']),
    movement_pattern:'isolation',
    equipment:'Cable',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['barbell_curl','ez_bar_curl','preacher_curl','concentration_curl']),
    contraindication_note:'手腕疼痛者換繩索或改中立握。',
    coaching_cues:Object.freeze(['肘固定夾身側','拉柄至肩','頂點略停','離心完整']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  preacher_curl:Object.freeze({
    primary_muscle:'biceps_brachii',
    secondary_muscles:Object.freeze(['brachialis']),
    movement_pattern:'isolation',
    equipment:'Machine',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['barbell_curl','ez_bar_curl','cable_curl','incline_dumbbell_curl','spider_curl']),
    contraindication_note:'肘伸直末端不適者縮幅度。',
    coaching_cues:Object.freeze(['腋下貼墊','握距肩寬','彎至頂點','離心不完全鎖死肘']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  concentration_curl:Object.freeze({
    primary_muscle:'biceps_brachii',
    secondary_muscles:Object.freeze(['brachialis']),
    movement_pattern:'isolation',
    equipment:'Dumbbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['cable_curl','incline_dumbbell_curl','preacher_curl','spider_curl','hammer_curl']),
    contraindication_note:'下背姿勢不良者抬頭挺胸。',
    coaching_cues:Object.freeze(['坐姿肘靠大腿內','彎至頂點略停','離心完整','穩住上臂']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  incline_dumbbell_curl:Object.freeze({
    primary_muscle:'biceps_brachii',
    secondary_muscles:Object.freeze(['brachialis']),
    movement_pattern:'isolation',
    equipment:'Dumbbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['concentration_curl','cable_curl','preacher_curl','barbell_curl','spider_curl']),
    contraindication_note:'肩前側不適者降負荷。',
    coaching_cues:Object.freeze(['椅背 45–60 度','手臂自然下垂','彎至頂點','離心完整伸直']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  hammer_curl:Object.freeze({
    primary_muscle:'brachialis',
    secondary_muscles:Object.freeze(['biceps_brachii','forearm_flexors']),
    movement_pattern:'isolation',
    equipment:'Dumbbell',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['cable_curl','concentration_curl','barbell_curl','reverse_curl']),
    contraindication_note:'手肘外側疼痛者降負荷。',
    coaching_cues:Object.freeze(['中立握啞鈴','肘夾身側','彎至頂點','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  sumo_deadlift:Object.freeze({
    primary_muscle:'gluteus_maximus',
    secondary_muscles:Object.freeze(['quadriceps','hamstrings','adductors','erector_spinae','trapezius']),
    movement_pattern:'hinge',
    equipment:'Barbell',
    goal_tags:Object.freeze(['strength']),
    skill_level:'advanced',
    ...
    recommended_set_range:Object.freeze([3,5]),
    recommended_frequency:'每週 1 次',
    rest_guidance:'180 秒以上',
    swap_candidates:Object.freeze(['conventional_deadlift','trap_bar_deadlift','romanian_deadlift']),
    contraindication_note:'髖內收柔軟度不足者改傳統硬舉。',
    coaching_cues:Object.freeze(['站距寬腳尖外','髖壓低貼槓','肩胛與核心先鎖','膝開同腳尖']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','acsm_ps_progression_2009'])
  }),
  pendlay_row:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['rhomboids','trapezius','posterior_deltoid','biceps_brachii']),
    movement_pattern:'horizontal_pull',
    equipment:'Barbell',
    ...
    skill_level:'advanced',
    fatigue_cost:'high',
    recommended_rep_range:Object.freeze([5,8]),
    recommended_set_range:Object.freeze([3,5]),
    recommended_frequency:'每週 1 次',
    rest_guidance:'120–180 秒',
    swap_candidates:Object.freeze(['barbell_row','t_bar_row','meadows_row','chest_supported_row']),
    contraindication_note:'下背痛者改胸托或坐姿划船。',
    coaching_cues:Object.freeze(['軀幹幾乎平行地面','每次從地板起拉','爆發拉至下胸','控制回地面']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','schoenfeld_volume_2017'])
  }),
  meadows_row:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['rhomboids','trapezius','posterior_deltoid','biceps_brachii']),
    movement_pattern:'horizontal_pull',
    equipment:'Barbell',
    ...
    recommended_frequency:'每週 1 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['single_arm_dumbbell_row','t_bar_row','barbell_row','chest_supported_row']),
    contraindication_note:'下背不適者降負荷或改胸托划船。',
    coaching_cues:Object.freeze(['腳側身站槓端','髖鉸鏈到位','單手拉至腰側','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  inverted_row:Object.freeze({
    primary_muscle:'latissimus_dorsi',
    secondary_muscles:Object.freeze(['rhomboids','trapezius','posterior_deltoid','biceps_brachii']),
    movement_pattern:'horizontal_pull',
    equipment:'Bodyweight',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['chest_supported_row','cable_row','seated_cable_row','machine_row']),
    contraindication_note:'肩前鬆弛者降負荷或改器械。',
    coaching_cues:Object.freeze(['身體一直線','握距略寬於肩','拉胸至槓','核心收緊']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  reverse_cable_fly:Object.freeze({
    primary_muscle:'posterior_deltoid',
    secondary_muscles:Object.freeze(['rhomboids','trapezius']),
    movement_pattern:'isolation',
    equipment:'Cable',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['rear_delt_fly','reverse_pec_deck','face_pull']),
    contraindication_note:'肩前鬆弛者降負荷。',
    coaching_cues:Object.freeze(['雙手交叉握對側線','手肘微彎','向後畫弧','頂點略停']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  spider_curl:Object.freeze({
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['preacher_curl','concentration_curl','incline_dumbbell_curl','cable_curl']),
    contraindication_note:'肩前側疼痛者改 preacher curl。',
    coaching_cues:Object.freeze(['上斜椅背俯姿','手臂自然垂直','彎至頂點收縮','離心完整']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  reverse_curl:Object.freeze({
    primary_muscle:'brachialis',
    secondary_muscles:Object.freeze(['biceps_brachii','forearm_flexors']),
    movement_pattern:'isolation',
    equipment:'Barbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['hammer_curl','cable_curl','barbell_curl']),
    contraindication_note:'手腕不適者改 EZ 槓。',
    coaching_cues:Object.freeze(['正握槓鈴','肘夾身側','彎至頂點','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  front_squat:Object.freeze({
    primary_muscle:'quadriceps',
    secondary_muscles:Object.freeze(['gluteus_maximus','erector_spinae','upper_trapezius']),
    movement_pattern:'squat',
    equipment:'Barbell',
    goal_tags:Object.freeze(['strength','hypertrophy']),
    skill_level:'advanced',
    fatigue_cost:'high',
    recommended_rep_range:Object.freeze([4,8]),
    recommended_set_range:Object.freeze([3,5]),
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'120–180 秒',
    swap_candidates:Object.freeze(['back_squat','hack_squat','goblet_squat','smith_squat','leg_press']),
    contraindication_note:'手腕柔軟度不足者改 cross-arm 握或改高腳杯。',
    coaching_cues:Object.freeze(['槓鎖鎖骨上緣','手肘高舉','軀幹保持挺直','下蹲至大腿平']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','acsm_ps_progression_2009'])
  }),
  smith_squat:Object.freeze({
    primary_muscle:'quadriceps',
    secondary_muscles:Object.freeze(['gluteus_maximus','hamstrings','adductors']),
    movement_pattern:'squat',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['back_squat','hack_squat','leg_press','goblet_squat','front_squat']),
    contraindication_note:'固定軌跡對膝前側敏感者不友善，疼痛即停。',
    coaching_cues:Object.freeze(['腳略前站斜向','核心收緊','下蹲至大腿平','膝對腳尖']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  hack_squat:Object.freeze({
    primary_muscle:'quadriceps',
    secondary_muscles:Object.freeze(['gluteus_maximus','hamstrings','adductors']),
    movement_pattern:'squat',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–150 秒',
    swap_candidates:Object.freeze(['back_squat','leg_press','smith_squat','front_squat','single_leg_press']),
    contraindication_note:'膝前側敏感者縮幅度或改腿推。',
    coaching_cues:Object.freeze(['肩抵墊、腳中置','核心收緊','下蹲至大腿平','穩定推起']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','schoenfeld_volume_2017'])
  }),
  bulgarian_split_squat:Object.freeze({
    primary_muscle:'quadriceps',
    secondary_muscles:Object.freeze(['gluteus_maximus','hamstrings','adductors']),
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'75–120 秒',
    swap_candidates:Object.freeze(['split_squat','smith_split_squat','walking_lunge','reverse_lunge','step_up']),
    contraindication_note:'前膝疼痛者縮幅度或改後腳平站分腿蹲。',
    coaching_cues:Object.freeze(['後腳擺椅墊','前腳微前站','下蹲至後膝近地','前膝對腳尖']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','schoenfeld_volume_2017'])
  }),
  smith_split_squat:Object.freeze({
    primary_muscle:'quadriceps',
    secondary_muscles:Object.freeze(['gluteus_maximus','hamstrings']),
    movement_pattern:'lunge',
    equipment:'Machine',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'75–120 秒',
    swap_candidates:Object.freeze(['bulgarian_split_squat','split_squat','walking_lunge','reverse_lunge']),
    contraindication_note:'固定軌跡對腳定位敏感，腳位太後易傷膝。',
    coaching_cues:Object.freeze(['腳前站','後腳屈膝','下蹲至後膝近地','穩定推起']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  split_squat:Object.freeze({
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['bulgarian_split_squat','walking_lunge','reverse_lunge','step_up']),
    contraindication_note:'膝疼痛者縮幅度。',
    coaching_cues:Object.freeze(['雙腳前後分站','下蹲至後膝近地','前膝對腳尖','穩定推起']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  walking_lunge:Object.freeze({
    primary_muscle:'quadriceps',
    secondary_muscles:Object.freeze(['gluteus_maximus','hamstrings','adductors']),
    movement_pattern:'lunge',
    equipment:'Dumbbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'75–120 秒',
    swap_candidates:Object.freeze(['walking_db_lunge','reverse_lunge','bulgarian_split_squat','split_squat','step_up']),
    contraindication_note:'前膝疼痛者改反向弓步或分腿蹲。',
    coaching_cues:Object.freeze(['雙手提啞鈴','跨步下蹲','後膝近地','前膝對腳尖']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  walking_db_lunge:Object.freeze({
    primary_muscle:'quadriceps',
    secondary_muscles:Object.freeze(['gluteus_maximus','hamstrings','adductors']),
    movement_pattern:'lunge',
    equipment:'Dumbbell',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'75–120 秒',
    swap_candidates:Object.freeze(['walking_lunge','reverse_lunge','bulgarian_split_squat']),
    contraindication_note:'膝疼痛者改反向弓步或分腿蹲。',
    coaching_cues:Object.freeze(['雙手提啞鈴','連續前跨','後膝近地','前膝對腳尖']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  reverse_lunge:Object.freeze({
    primary_muscle:'gluteus_maximus',
    secondary_muscles:Object.freeze(['quadriceps','hamstrings','adductors']),
    movement_pattern:'lunge',
    equipment:'Dumbbell',
    goal_tags:Object.freeze(['hypertrophy','general_health']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['split_squat','bulgarian_split_squat','walking_lunge','step_up']),
    contraindication_note:'對膝關節較友善；踝柔軟度不足仍須小幅度。',
    coaching_cues:Object.freeze(['向後跨','下蹲至後膝近地','前膝對腳尖','推前腳回起姿']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  step_up:Object.freeze({
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['split_squat','reverse_lunge','bulgarian_split_squat','walking_lunge']),
    contraindication_note:'箱高過高對膝不利，維持大腿不超過水平。',
    coaching_cues:Object.freeze(['腳全掌踩箱','推前腳站起','避免後腳借力','控制下回']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  hip_thrust:Object.freeze({
    primary_muscle:'gluteus_maximus',
    secondary_muscles:Object.freeze(['hamstrings','quadriceps','erector_spinae']),
    movement_pattern:'hinge',
    equipment:'Barbell',
    goal_tags:Object.freeze(['strength','hypertrophy']),
    skill_level:'intermediate',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['smith_hip_thrust','glute_bridge','romanian_deadlift','back_extension']),
    contraindication_note:'下背壓力敏感者避免過度伸髖。',
    coaching_cues:Object.freeze(['肩胛靠臥推椅下緣','槓置髖摺','核心收緊','頂點收臀']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','schoenfeld_volume_2017'])
  }),
  smith_hip_thrust:Object.freeze({
    primary_muscle:'gluteus_maximus',
    secondary_muscles:Object.freeze(['hamstrings','quadriceps']),
    movement_pattern:'hinge',
    equipment:'Machine',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'75–120 秒',
    swap_candidates:Object.freeze(['hip_thrust','glute_bridge','romanian_deadlift']),
    contraindication_note:'下背壓力敏感者避免過度伸髖。',
    coaching_cues:Object.freeze(['肩靠椅','槓置髖摺','核心收緊','頂點收臀略停']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  glute_bridge:Object.freeze({
    primary_muscle:'gluteus_maximus',
    secondary_muscles:Object.freeze(['hamstrings','erector_spinae']),
    movement_pattern:'hinge',
    equipment:'Bodyweight',
    goal_tags:Object.freeze(['general_health']),
    skill_level:'beginner',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([12,20]),
    recommended_set_range:Object.freeze([2,4]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'30–60 秒',
    swap_candidates:Object.freeze(['hip_thrust','smith_hip_thrust','back_extension']),
    contraindication_note:'下背不適者降幅度。',
    coaching_cues:Object.freeze(['仰躺屈膝','核心收緊','頂點收臀','控制下放']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  leg_extension:Object.freeze({
    primary_muscle:'quadriceps',
    secondary_muscles:Object.freeze([]),
    movement_pattern:'isolation',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['leg_press','hack_squat','front_squat']),
    contraindication_note:'膝前側急性痛者縮幅度或避免。',
    coaching_cues:Object.freeze(['背貼椅墊','腳踝置墊下','伸至伸直略停','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  leg_curl:Object.freeze({
    primary_muscle:'hamstrings',
    secondary_muscles:Object.freeze(['gastrocnemius']),
    movement_pattern:'isolation',
    equipment:'Machine',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['romanian_deadlift','nordic_curl','back_extension']),
    contraindication_note:'後腿肌抽筋敏感者縮負荷、重視熱身。',
    coaching_cues:Object.freeze(['腳踝置墊上','髖貼墊','勾至最大屈膝','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  hip_abduction_machine:Object.freeze({
    primary_muscle:'gluteus_medius',
    secondary_muscles:Object.freeze(['gluteus_maximus']),
    movement_pattern:'isolation',
    equipment:'Machine',
    goal_tags:Object.freeze(['hypertrophy','general_health']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['hip_adduction_machine','hip_thrust','glute_bridge']),
    contraindication_note:'髖外側不適者降負荷。',
    coaching_cues:Object.freeze(['坐穩椅墊','腳外張至最大','頂點略停','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  hip_adduction_machine:Object.freeze({
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['hip_abduction_machine','goblet_squat','cossack_squat']),
    contraindication_note:'髖內收拉傷史者降幅度。',
    coaching_cues:Object.freeze(['坐穩椅墊','腳內夾至最大','頂點略停','離心控制']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  calf_raise:Object.freeze({
    primary_muscle:'gastrocnemius',
    secondary_muscles:Object.freeze(['soleus']),
    movement_pattern:'isolation',
    equipment:'Machine',
    goal_tags:Object.freeze(['hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['standing_calf_raise','seated_calf_raise']),
    contraindication_note:'跟腱炎者降負荷並降幅度。',
    coaching_cues:Object.freeze(['腳掌前緣踩台','踝完整下至底','抬至頂點略停','控制離心']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  seated_calf_raise:Object.freeze({
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['calf_raise','standing_calf_raise']),
    contraindication_note:'跟腱炎者降負荷。',
    coaching_cues:Object.freeze(['坐姿膝 90 度','腳前緣踩台','完整下伸再抬頂點','控制離心']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  standing_calf_raise:Object.freeze({
    primary_muscle:'gastrocnemius',
    secondary_muscles:Object.freeze(['soleus']),
    movement_pattern:'isolation',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['calf_raise','seated_calf_raise']),
    contraindication_note:'跟腱炎者降負荷。',
    coaching_cues:Object.freeze(['站姿膝伸直','腳前緣踩台','完整下伸再抬頂點','控制離心']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  back_extension:Object.freeze({
    primary_muscle:'erector_spinae',
    secondary_muscles:Object.freeze(['gluteus_maximus','hamstrings']),
    movement_pattern:'hinge',
    equipment:'Bodyweight',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'45–75 秒',
    swap_candidates:Object.freeze(['romanian_deadlift','hip_thrust','glute_bridge','nordic_curl']),
    contraindication_note:'下背急性痛者降幅度並避免過度伸展。',
    coaching_cues:Object.freeze(['髖摺靠墊','背部保持中立','下放至微屈','抬至與地面平行']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  nordic_curl:Object.freeze({
    primary_muscle:'hamstrings',
    secondary_muscles:Object.freeze(['gluteus_maximus','gastrocnemius']),
    movement_pattern:'isolation',
    equipment:'Bodyweight',
    goal_tags:Object.freeze(['hypertrophy','strength']),
    skill_level:'advanced',
    fatigue_cost:'high',
    recommended_rep_range:Object.freeze([3,8]),
    recommended_set_range:Object.freeze([3,4]),
    recommended_frequency:'每週 1 次',
    rest_guidance:'90–120 秒',
    swap_candidates:Object.freeze(['leg_curl','romanian_deadlift','back_extension']),
    contraindication_note:'後腿肌拉傷史者降幅度或改器械腿後勾。',
    coaching_cues:Object.freeze(['跪姿固定腳踝','身體離心下降','控制至極限','手撐地輔助回位']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  single_leg_press:Object.freeze({
    primary_muscle:'quadriceps',
    secondary_muscles:Object.freeze(['gluteus_maximus','hamstrings','adductors']),
    movement_pattern:'squat',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'75–120 秒',
    swap_candidates:Object.freeze(['leg_press','bulgarian_split_squat','step_up','split_squat']),
    contraindication_note:'膝前側急性痛者縮幅度。',
    coaching_cues:Object.freeze(['單腳全掌踩板','另一腳放地','下至大腿接近踏板','穩定推起']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  cossack_squat:Object.freeze({
    primary_muscle:'adductors',
    secondary_muscles:Object.freeze(['quadriceps','gluteus_maximus','hamstrings']),
    movement_pattern:'squat',
    equipment:'Bodyweight',
    goal_tags:Object.freeze(['general_health','hypertrophy']),
    skill_level:'intermediate',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['goblet_squat','bulgarian_split_squat','hip_adduction_machine','split_squat']),
    contraindication_note:'髖內收柔軟度不足者縮幅度。',
    coaching_cues:Object.freeze(['寬步側蹲','身側腳伸直','下蹲側膝對腳尖','換邊轉移']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  cable_crunch:Object.freeze({
    primary_muscle:'rectus_abdominis',
    secondary_muscles:Object.freeze(['obliques']),
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['crunch','hanging_leg_raise','lying_leg_raise','ab_wheel']),
    contraindication_note:'下背痛或腰椎間盤問題者避免屈曲負重。',
    coaching_cues:Object.freeze(['跪姿繩在頭後','腹收捲上半身','骨盆保持不動','離心控制']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  crunch:Object.freeze({
    ...
    skill_level:'beginner',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([12,25]),
    recommended_set_range:Object.freeze([3,4]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'30–60 秒',
    swap_candidates:Object.freeze(['cable_crunch','lying_leg_raise','dead_bug','plank']),
    contraindication_note:'下背痛者改 dead bug 或 plank。',
    coaching_cues:Object.freeze(['仰躺屈膝','下腹主導收縮','捲起肩胛離地','控制下放']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  hanging_leg_raise:Object.freeze({
    primary_muscle:'rectus_abdominis',
    secondary_muscles:Object.freeze(['obliques','hip_flexors']),
    movement_pattern:'flexion',
    equipment:'Bodyweight',
    goal_tags:Object.freeze(['hypertrophy','general_health']),
    skill_level:'intermediate',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['lying_leg_raise','cable_crunch','ab_wheel','hollow_hold']),
    contraindication_note:'肩關節不適者改仰臥抬腿。',
    coaching_cues:Object.freeze(['懸吊肩胛下沉','腿抬至水平','骨盆後傾','控制下放']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  lying_leg_raise:Object.freeze({
    primary_muscle:'rectus_abdominis',
    secondary_muscles:Object.freeze(['obliques','hip_flexors']),
    movement_pattern:'flexion',
    equipment:'Bodyweight',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['hanging_leg_raise','cable_crunch','crunch','dead_bug']),
    contraindication_note:'下背痛者降幅度並放手於下背下。',
    coaching_cues:Object.freeze(['仰躺雙手置臀下','腿抬至垂直','骨盆後傾','控制下放']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  plank:Object.freeze({
    primary_muscle:'rectus_abdominis',
    secondary_muscles:Object.freeze(['obliques','erector_spinae','gluteus_maximus']),
    movement_pattern:'anti_extension',
    equipment:'Bodyweight',
    goal_tags:Object.freeze(['general_health']),
    skill_level:'beginner',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([20,60]),
    recommended_set_range:Object.freeze([2,4]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'30–60 秒',
    swap_candidates:Object.freeze(['side_plank','dead_bug','hollow_hold','pallof_press']),
    contraindication_note:'肩腕痛者改前臂支撐或改 dead bug。',
    coaching_cues:Object.freeze(['前臂或手掌支撐','身體一直線','核心臀部收緊','呼吸平穩']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  side_plank:Object.freeze({
    primary_muscle:'obliques',
    secondary_muscles:Object.freeze(['gluteus_medius','quadratus_lumborum']),
    movement_pattern:'anti_extension',
    equipment:'Bodyweight',
    goal_tags:Object.freeze(['general_health']),
    skill_level:'beginner',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([20,45]),
    recommended_set_range:Object.freeze([2,4]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'30–60 秒',
    swap_candidates:Object.freeze(['plank','pallof_press','dead_bug','russian_twist']),
    contraindication_note:'肩痛者降撐度或改跪姿側撐。',
    coaching_cues:Object.freeze(['前臂垂直肩下','身體一直線','臀抬高','視線向前']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  russian_twist:Object.freeze({
    primary_muscle:'obliques',
    secondary_muscles:Object.freeze(['rectus_abdominis','hip_flexors']),
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'30–60 秒',
    swap_candidates:Object.freeze(['pallof_press','side_plank','dead_bug']),
    contraindication_note:'下背痛或椎間盤問題者改 Pallof press。',
    coaching_cues:Object.freeze(['坐姿腳抬','軀幹後傾約 45 度','左右轉動','控制幅度']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  dead_bug:Object.freeze({
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'30–60 秒',
    swap_candidates:Object.freeze(['plank','hollow_hold','pallof_press','lying_leg_raise']),
    contraindication_note:'下背敏感者降幅度。',
    coaching_cues:Object.freeze(['仰躺核心壓地','對側手腳緩慢伸出','下背不離地','換邊進行']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  pallof_press:Object.freeze({
    primary_muscle:'obliques',
    secondary_muscles:Object.freeze(['rectus_abdominis','gluteus_medius']),
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'45–60 秒',
    swap_candidates:Object.freeze(['side_plank','dead_bug','plank']),
    contraindication_note:'下背痛者改為 dead bug。',
    coaching_cues:Object.freeze(['側身站於滑輪旁','雙手握把置胸前','向前推直不讓身體轉','控制回位']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  ab_wheel:Object.freeze({
    primary_muscle:'rectus_abdominis',
    secondary_muscles:Object.freeze(['obliques','latissimus_dorsi','serratus_anterior']),
    movement_pattern:'anti_extension',
    equipment:'Bodyweight',
    goal_tags:Object.freeze(['hypertrophy','general_health']),
    skill_level:'intermediate',
    fatigue_cost:'moderate',
    recommended_rep_range:Object.freeze([5,12]),
    recommended_set_range:Object.freeze([3,4]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['plank','hanging_leg_raise','hollow_hold','dead_bug']),
    contraindication_note:'下背痛者改 dead bug 或縮幅度。',
    coaching_cues:Object.freeze(['跪姿握輪','核心收緊','向前滾至極限','控制滾回']),
    evidence_ref_ids:Object.freeze(['schoenfeld_volume_2017'])
  }),
  hollow_hold:Object.freeze({
    primary_muscle:'rectus_abdominis',
    secondary_muscles:Object.freeze(['obliques','hip_flexors']),
    movement_pattern:'anti_extension',
    equipment:'Bodyweight',
    ...
    skill_level:'intermediate',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([15,45]),
    recommended_set_range:Object.freeze([2,4]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'30–60 秒',
    swap_candidates:Object.freeze(['plank','dead_bug','ab_wheel']),
    contraindication_note:'下背敏感者縮腿幅度。',
    coaching_cues:Object.freeze(['仰躺下背壓地','手腿同時抬離','保持身體弧形','呼吸平穩']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  farmer_carry:Object.freeze({
    primary_muscle:'full_body',
    secondary_muscles:Object.freeze(['trapezius','forearm_flexors','obliques','quadriceps']),
    movement_pattern:'carry',
    equipment:'Dumbbell',
    goal_tags:Object.freeze(['general_health','strength']),
    skill_level:'beginner',
    fatigue_cost:'moderate',
    recommended_rep_range:Object.freeze([20,60]),
    recommended_set_range:Object.freeze([3,4]),
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['goblet_squat','trap_bar_deadlift']),
    contraindication_note:'握力疲勞先於核心者降重量延時間。',
    coaching_cues:Object.freeze(['雙手提啞鈴','肩胛下沉','軀幹直立','穩定行走']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  trap_bar_deadlift:Object.freeze({
    primary_muscle:'gluteus_maximus',
    secondary_muscles:Object.freeze(['quadriceps','hamstrings','erector_spinae','trapezius']),
    movement_pattern:'hinge',
    equipment:'Barbell',
    goal_tags:Object.freeze(['strength','general_health']),
    skill_level:'beginner',
    fatigue_cost:'high',
    recommended_rep_range:Object.freeze([5,10]),
    recommended_set_range:Object.freeze([3,5]),
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'120–180 秒',
    swap_candidates:Object.freeze(['conventional_deadlift','romanian_deadlift','sumo_deadlift']),
    contraindication_note:'下背急性痛者仍須降負荷；對多數人剪力較低。',
    coaching_cues:Object.freeze(['站於六角槓中','肩胛與核心先鎖','髖主導起槓','膝與腳尖同向']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021','acsm_ps_progression_2009'])
  }),
  goblet_squat:Object.freeze({
    primary_muscle:'quadriceps',
    secondary_muscles:Object.freeze(['gluteus_maximus','adductors','rectus_abdominis']),
    movement_pattern:'squat',
    equipment:'Dumbbell',
    goal_tags:Object.freeze(['general_health','hypertrophy']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 1–2 次',
    rest_guidance:'60–90 秒',
    swap_candidates:Object.freeze(['back_squat','front_squat','smith_squat','leg_press','cossack_squat']),
    contraindication_note:'膝或下背急性痛者縮幅度或改器械。',
    coaching_cues:Object.freeze(['雙手抱啞鈴於胸前','腳寬略大於肩','核心穩定下蹲','膝對腳尖']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  stepper:Object.freeze({
    primary_muscle:'cardiovascular_system',
    secondary_muscles:Object.freeze(['quadriceps','gluteus_maximus','gastrocnemius']),
    movement_pattern:'cardio',
    equipment:'Machine',
    goal_tags:Object.freeze(['cardio_endurance','fat_loss','general_health']),
    skill_level:'beginner',
    fatigue_cost:'moderate',
    recommended_rep_range:Object.freeze([15,45]),
    recommended_set_range:Object.freeze([1,1]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['stair_climber','treadmill_walk','elliptical','bike']),
    contraindication_note:'膝關節急性痛者改橢圓機或健身車。',
    coaching_cues:Object.freeze(['身體直立勿伏把','踩完整幅度','配速均勻','控制呼吸']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  stair_climber:Object.freeze({
    primary_muscle:'cardiovascular_system',
    secondary_muscles:Object.freeze(['quadriceps','gluteus_maximus','gastrocnemius']),
    movement_pattern:'cardio',
    equipment:'Machine',
    goal_tags:Object.freeze(['cardio_endurance','fat_loss']),
    skill_level:'beginner',
    fatigue_cost:'moderate',
    recommended_rep_range:Object.freeze([15,45]),
    recommended_set_range:Object.freeze([1,1]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['stepper','treadmill_walk','elliptical','bike']),
    contraindication_note:'膝關節急性痛者改橢圓機。',
    coaching_cues:Object.freeze(['身體直立','踩完整幅度','配速均勻','控制呼吸']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  treadmill_run:Object.freeze({
    primary_muscle:'cardiovascular_system',
    secondary_muscles:Object.freeze(['quadriceps','hamstrings','gluteus_maximus','gastrocnemius']),
    movement_pattern:'cardio',
    equipment:'Machine',
    goal_tags:Object.freeze(['cardio_endurance','fat_loss']),
    skill_level:'intermediate',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['outdoor_run','treadmill_jog','elliptical','bike','rower']),
    contraindication_note:'關節急性痛者改快走／橢圓／健身車。',
    coaching_cues:Object.freeze(['腳掌中段著地','步頻 170+','軀幹微前傾','呼吸節律穩']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  treadmill_walk:Object.freeze({
    primary_muscle:'cardiovascular_system',
    secondary_muscles:Object.freeze(['quadriceps','gluteus_maximus','gastrocnemius']),
    movement_pattern:'cardio',
    equipment:'Machine',
    ...
    recommended_rep_range:Object.freeze([20,60]),
    recommended_set_range:Object.freeze([1,1]),
    recommended_frequency:'每週 3–5 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['outdoor_walk','walking','treadmill_jog','bike','elliptical']),
    contraindication_note:'血壓過高者避免過陡斜坡。',
    coaching_cues:Object.freeze(['軀幹直立','自然擺臂','步幅中等','呼吸均勻']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  treadmill_jog:Object.freeze({
    primary_muscle:'cardiovascular_system',
    secondary_muscles:Object.freeze(['quadriceps','hamstrings','gluteus_maximus','gastrocnemius']),
    movement_pattern:'cardio',
    equipment:'Machine',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['treadmill_run','outdoor_run','bike','elliptical']),
    contraindication_note:'關節疼痛者改快走或橢圓。',
    coaching_cues:Object.freeze(['腳掌中段著地','軀幹微前傾','步頻均勻','呼吸穩定']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  outdoor_run:Object.freeze({
    primary_muscle:'cardiovascular_system',
    secondary_muscles:Object.freeze(['quadriceps','hamstrings','gluteus_maximus','gastrocnemius']),
    movement_pattern:'cardio',
    equipment:'Bodyweight',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['treadmill_run','treadmill_jog','outdoor_walk','bike']),
    contraindication_note:'關節急性痛者改快走或橢圓。',
    coaching_cues:Object.freeze(['注意地面狀況','步頻 170+','軀幹微前傾','補水充足']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  outdoor_walk:Object.freeze({
    primary_muscle:'cardiovascular_system',
    secondary_muscles:Object.freeze(['quadriceps','gluteus_maximus','gastrocnemius']),
    movement_pattern:'cardio',
    equipment:'Bodyweight',
    goal_tags:Object.freeze(['cardio_endurance','general_health','fat_loss']),
    skill_level:'beginner',
    fatigue_cost:'low',
    recommended_rep_range:Object.freeze([20,90]),
    recommended_set_range:Object.freeze([1,1]),
    recommended_frequency:'每週 3–5 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['treadmill_walk','walking','bike','elliptical']),
    contraindication_note:'日照過強注意補水與防曬。',
    coaching_cues:Object.freeze(['軀幹直立','自然擺臂','配速穩','呼吸均勻']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  bike:Object.freeze({
    primary_muscle:'cardiovascular_system',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['elliptical','rower','treadmill_walk','stair_climber']),
    contraindication_note:'會陰敏感者調整坐墊。',
    coaching_cues:Object.freeze(['坐墊高使膝微屈','配速均勻','軀幹微前傾','呼吸均勻']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  elliptical:Object.freeze({
    primary_muscle:'cardiovascular_system',
    secondary_muscles:Object.freeze(['quadriceps','gluteus_maximus','hamstrings','latissimus_dorsi']),
    movement_pattern:'cardio',
    equipment:'Machine',
    goal_tags:Object.freeze(['cardio_endurance','fat_loss','general_health']),
    skill_level:'beginner',
    ...
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['bike','treadmill_walk','stair_climber','rower']),
    contraindication_note:'肩不適者可放開把手改扶欄杆。',
    coaching_cues:Object.freeze(['身體直立','腳掌完整踩板','配速均勻','呼吸平穩']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  rower:Object.freeze({
    primary_muscle:'cardiovascular_system',
    secondary_muscles:Object.freeze(['latissimus_dorsi','rhomboids','quadriceps','gluteus_maximus','erector_spinae']),
    movement_pattern:'cardio',
    equipment:'Machine',
    goal_tags:Object.freeze(['cardio_endurance','fat_loss','general_health']),
    skill_level:'intermediate',
    fatigue_cost:'moderate',
    recommended_rep_range:Object.freeze([15,30]),
    recommended_set_range:Object.freeze([1,1]),
    recommended_frequency:'每週 2–3 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['bike','elliptical','treadmill_jog','stair_climber']),
    contraindication_note:'下背痛者降負荷並保持脊柱中立。',
    coaching_cues:Object.freeze(['腳→髖→背→手順序','回位反順序','背部中立','配速均勻']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  }),
  walking:Object.freeze({
    ...
    recommended_frequency:'每週 3–5 次',
    rest_guidance:'視有氧段落安排',
    swap_candidates:Object.freeze(['outdoor_walk','treadmill_walk','bike','elliptical']),
    contraindication_note:'關節急性痛時縮時間。',
    coaching_cues:Object.freeze(['軀幹直立','自然擺臂','步頻穩定','呼吸均勻']),
    evidence_ref_ids:Object.freeze(['acsm_gl_2021'])
  })
});
...
// Phase 9: explain why a swap candidate ranks. Best-effort 1–2 line reason.
// Reads SWAP_META / EXERCISE_METADATA only; never mutates. Safe fallback: ''.
function explainSwap(baseKey,candKey){
  if(!baseKey||!candKey||baseKey===candKey)return'';
  const bm=SWAP_META[baseKey]||null;
  const cm=SWAP_META[candKey]||null;
  const bem=(typeof Knowledge!=='undefined'&&Knowledge.getExerciseMetadata)?Knowledge.getExerciseMetadata(baseKey):null;
  const cem=(typeof Knowledge!=='undefined'&&Knowledge.getExerciseMetadata)?Knowledge.getExerciseMetadata(candKey):null;
  const reasons=[];
  if(bm&&cm){
    if(bm.mp===cm.mp&&bm.mp)reasons.push('同動作型態');
    if(bm.pmg===cm.pmg&&bm.pmg)reasons.push('同主要肌群');
    if(bm.er===cm.er&&bm.er)reasons.push('同動作角色');
  }
  if(bem&&cem){
    if(bem.primary_muscle&&bem.primary_muscle===cem.primary_muscle&&!reasons.includes('同主要肌群'))reasons.push('主肌群一致');
    if(bem.equipment&&cem.equipment&&bem.equipment===cem.equipment)reasons.push('同器材');
    const bg=Array.isArray(bem.goal_tags)?bem.goal_tags:[];
    const cg=Array.isArray(cem.goal_tags)?cem.goal_tags:[];
    const overlap=bg.filter(g=>cg.includes(g));
    if(overlap.length)reasons.push('目標匹配 '+overlap.slice(0,2).join('/'));
    const fatigueOrder=['low','low_moderate','moderate','high','very_high'];
    if(bem.fatigue_cost&&cem.fatigue_cost){
      const bi=fatigueOrder.indexOf(bem.fatigue_cost);
      const ci=fatigueOrder.indexOf(cem.fatigue_cost);
      if(bi>=0&&ci>=0&&Math.abs(bi-ci)<=1&&bem.fatigue_cost!==cem.fatigue_cost)reasons.push('疲勞成本接近');
      else if(bi>=0&&ci>=0&&ci<bi)reasons.push('較低疲勞成本');
    }
    const be=Array.isArray(bem.evidence_ref_ids)?bem.evidence_ref_ids:[];
    const ce=Array.isArray(cem.evidence_ref_ids)?cem.evidence_ref_ids:[];
    if(be.length&&ce.length&&be.some(id=>ce.includes(id)))reasons.push('共享 ACSM 依據');
  }
  // Fallback: if no structured reason and both in SWAP_META with same category.
  if(!reasons.length){
    const bd=EX_BY_KEY[baseKey];const cd=EX_BY_KEY[candKey];
    if(bd&&cd&&bd.category===cd.category)reasons.push('同分類');
  }
  ...
  render(){
    ...
    if(this.mode==='swap'&&this.swapBaseKey){
      ...
      if(!q){
        ...
        const mkItem=k=>{const d=EX_BY_KEY[k];if(!d)return'';const reason=explainSwap(this.swapBaseKey,k);const rHtml=reason?`<span class="swap-reason">${Utils.escape(reason)}</span>`:'';return`<button class="select-option select-option-swap" data-library-key="${k}"><strong>${Utils.escape(d.labelEn)}｜${Utils.escape(d.labelZh)}</strong><small>${Utils.escape(d.category)} · ${Utils.escape(d.equipment)}</small>${rHtml}</button>`};
        let html='';
...
const SC={
  ...
  init(){$('#home-version-pill').textContent=`v${APP_VERSION}`;$('#weight-date').value=Utils.today();$('#cardio-date').value=Utils.today();$('#report-daily-date').value=Utils.today();$('#report-weekly-date').value=Utils.weekStart(Utils.today());App.onChange(()=>this.renderHome());this.renderHome()},
  renderHome(){
    $('#home-date-label').textContent=Utils.formatDate(Utils.today());
    const selfBtn=$('#home-mode-self');const coachBtn=$('#home-mode-coach');
    const selfView=$('#home-view-self');const coachView=$('#home-view-coach');
    const isCoach=App.isCoach();
    if(selfBtn){selfBtn.classList.toggle('active',!isCoach);selfBtn.setAttribute('aria-selected',String(!isCoach))}
    if(coachBtn){coachBtn.classList.toggle('active',isCoach);coachBtn.setAttribute('aria-selected',String(isCoach))}
    if(selfView)selfView.classList.toggle('hidden',isCoach);
    if(coachView)coachView.classList.toggle('hidden',!isCoach);
    if(isCoach)this.renderHomeCoach();else this.renderHomeSelf();
  },
  renderHomeSelf(){const s=PS.selected();$('#home-program-name').textContent=s?s.name:'尚未選擇課表';$('#home-program-meta').textContent=s?`${s.category||'Program'} · ${(s.exercises||[]).length} 個動作`:'請先選擇今天要使用的課表。';
  ...
  renderHomeCoach(){
    ...
    const clients=Workspace.coachClients()||[];
    const active=clients.filter(c=>!c.isArchived);
    const sessions=(Workspace.coachSessions()||[]).slice();
    const weekStartTs=new Date(Utils.weekStart(Utils.today())+'T00:00:00').getTime();
    const weekCount=sessions.filter(s=>{const t=s.finishedAt||s.startedAt||0;return t>=weekStartTs}).length;
    const wc=$('#coach-home-week-count');if(wc)wc.textContent=String(weekCount);
    const defId=(CDB.data.settings&&CDB.data.settings.defaultClientId)||'';
    const defClient=defId?Clients.byId(defId):null;
    const titleEl=$('#coach-home-title');
    const metaEl=$('#coach-home-meta');
    if(titleEl)titleEl.textContent=defClient?defClient.name:(active.length?`${active.length} 位學員`:'尚未新增學員');
    if(metaEl){
      if(defClient){metaEl.textContent=`預設學員 · ${defClient.goal||'—'}`}
      else if(active.length){metaEl.textContent='點擊任一入口以管理學員與課程。'}
      else{metaEl.textContent='請先新增第一位學員開始。'}
    }
    const listEl=$('#coach-home-recent-list');
    if(listEl){
      const recent=sessions.sort((a,b)=>((b.finishedAt||b.startedAt||0)-(a.finishedAt||a.startedAt||0))).slice(0,5);
      if(!recent.length){listEl.innerHTML='<div class="empty">尚無課程紀錄</div>'}
      else{
        listEl.innerHTML=recent.map(s=>{
          const t=s.finishedAt||s.startedAt||0;
          const dateText=t?Utils.formatDateTime(t):(s.date||'');
  ...
  renderPrograms(){
    ...
    $('#program-list').innerHTML=empty||list.map(p=>{
      ...
      // V5.1.1: ACSM block — full metadata for built-in, derived summary for custom.
      ...
      if(pm){
        ...
        const pg=Utils.escape(pm.primary_goal||'');
        const st=Utils.escape(pm.split_type||'');
        const rs=Utils.escape(pm.rationale_summary||'');
        const evCount=Array.isArray(pm.evidence_ref_ids)?pm.evidence_ref_ids.length:0;
        const evPill=evCount?`<span class="pill pill-evidence">ACSM 依據 ${evCount} 筆</span>`:'';
        const metaRow=[st,pg,fr].filter(Boolean).map(x=>`<span>${x}</span>`).join('');
        acsmBlock=`<div class="program-rationale">${metaRow?`<div class="meta rationale-meta">${metaRow}${evPill}</div>`:''}${rs?`<div class="rationale-body">${rs}</div>`:''}</div>`;
      }else if(!p.builtIn&&typeof AcsmAnalyzer!=='undefined'){
        // V5.1.1: compact ACSM footnote for custom programs derived from metadata.
        try{
          const a=AcsmAnalyzer.analyzeProgram(p);
          if(a&&a.total){
            const topM=Object.entries(a.muscleDist).sort((x,y)=>y[1]-x[1]).slice(0,2).map(e=>`${e[0]}×${e[1]}`).join('、');
            const topP=Object.entries(a.patternDist).sort((x,y)=>y[1]-x[1]).slice(0,2).map(e=>`${e[0]}×${e[1]}`).join('、');
            const bits=[];if(topM)bits.push(topM);if(topP)bits.push(topP);if(a.highFatigueCount)bits.push(`高疲勞 ${a.highFatigueCount}/${a.total}`);
            if(bits.length)acsmBlock=`<div class="program-rationale program-rationale-custom"><div class="meta rationale-meta"><span class="acsm-inline-tag">ACSM 摘要</span><span>${Utils.escape(bits.join(' · '))}</span></div></div>`;
          }
        }catch(e){}
      }
      return`<div class="item"><div class="row between wrap"><div style="min-width:0"><h3>${Utils.escape(p.name)}</h3><div class="meta"><span>${Utils.escape(p.category||'Program')} · ${(p.exercises||[]).length} 個動作${p.builtIn?' · 內建':' · 自訂'}</span>${splitPill}${iS?'<span class="pill">使用中</span>':''}${rec?'<span class="pill">推薦</span>':''}${incompleteTag}</div>${p.note?`<div class="subtle" style="margin-top:8px">${Utils.escape(p.note)}</div>`:''}${nextHint}${acsmBlock}<div class="recommendation-score rec-score-badge" data-tier="${tierKey}" style="margin-top:8px"><span class="rec-tier">${tier}</span><span class="rec-dot">·</span><span class="rec-num">${sc.toFixed(1)}</span></div></div></div><div class="item-actions"><button class="btn ${iS?'strong':'primary'}" data-action="select-program" data-id="${p.id}">${iS?'已選擇':'設為今日'}</button><button class="btn btn-sub" data-action="edit-program" data-id="${p.id}">編輯</button><button class="btn btn-sub" data-action="copy-program" data-id="${p.id}">複製</button>${p.builtIn?'':`<button class="btn btn-sub btn-sub-danger" data-action="delete-program" data-id="${p.id}">刪除</button>`}</div></div>`
    }).join('');
  },
  ...
  _buildHistoryDetailAcsmBlock(session){
    ...
    try{
      ...
      const obs=(a.observations||[]).filter(o=>!/資料不足|略過/.test(o)).slice(0,3);
      if(!obs.length)return'';
      return`<div class="history-acsm-block" role="note"><span class="acsm-inline-tag">ACSM</span><div class="history-acsm-body">${obs.map(o=>`<div class="history-acsm-line">${Utils.escape(o)}</div>`).join('')}</div></div>`;
    }catch(e){return''}
  },
  ...
  renderScienceAcsm(){
    ...
    if(detailEl&&!this.scienceAcsmCollapsed){
      ...
      if(!em){detailEl.innerHTML='<div class="empty">尚未有 ACSM 動作資料</div>';}
        ...
        const title=Utils.escape(exLabel(key));
        const pm=Utils.escape(em.primary_muscle||'—');
        const sec=(Array.isArray(em.secondary_muscles)?em.secondary_muscles:[]).map(x=>`<span class="edu-chip">${Utils.escape(x)}</span>`).join('')||'<span class="edu-chip">—</span>';
        const mp=Utils.escape(em.movement_pattern||'—');
        const eq=Utils.escape(em.equipment||'—');
        const gt=(Array.isArray(em.goal_tags)?em.goal_tags:[]).map(x=>`<span class="pill">${Utils.escape(x)}</span>`).join('')||'—';
        const sk=Utils.escape(em.skill_level||'—');
        const fc=Utils.escape(em.fatigue_cost||'—');
        const rep=Array.isArray(em.recommended_rep_range)&&em.recommended_rep_range.length===2?`${em.recommended_rep_range[0]}–${em.recommended_rep_range[1]} reps`:'—';
        const st=Array.isArray(em.recommended_set_range)&&em.recommended_set_range.length===2?`${em.recommended_set_range[0]}–${em.recommended_set_range[1]} 組`:'—';
        const fr=Utils.escape(em.recommended_frequency||'—');
        const rg=Utils.escape(em.rest_guidance||'—');
        const ci=em.contraindication_note?`<div class="muted-box science-warning"><strong>注意</strong><div class="subtle" style="margin-top:6px">${Utils.escape(em.contraindication_note)}</div></div>`:'';
        const cues=(Array.isArray(em.coaching_cues)?em.coaching_cues:[]).map(x=>`<div class="edu-item">${Utils.escape(x)}</div>`).join('')||'<div class="edu-item">—</div>';
        const refs=Knowledge.getEvidenceRefsFor('exercise',key);
        const refsHtml=refs.length?refs.map(r=>`<div class="acsm-ref-line"><strong>${Utils.escape(r.source||'')}</strong> · ${Utils.escape(String(r.year||''))} · ${Utils.escape(r.title||'')}</div>`).join(''):'<div class="subtle">—</div>';
        detailEl.innerHTML=`<div class="acsm-detail-head"><h3>${title}</h3><div class="meta"><span>${mp}</span><span>${eq}</span><span>難度 ${sk}</span><span>疲勞 ${fc}</span></div></div>
<div class="acsm-kv-grid">
  <div class="science-kv"><div class="label">主要肌群</div><div class="value">${pm}</div></div>
  <div class="science-kv"><div class="label">次要肌群</div><div class="edu-chip-row">${sec}</div></div>
  <div class="science-kv"><div class="label">目標</div><div class="chip-row">${gt}</div></div>
  <div class="science-kv"><div class="label">建議次數</div><div class="value">${rep}</div></div>
  <div class="science-kv"><div class="label">建議組數</div><div class="value">${st}</div></div>
  <div class="science-kv"><div class="label">建議頻率</div><div class="value">${fr}</div></div>
  <div class="science-kv"><div class="label">休息指引</div><div class="value">${rg}</div></div>
</div>
<div class="acsm-cue-block"><div class="label">教練提示</div><div class="edu-list">${cues}</div></div>
${ci}
<div class="acsm-refs-block"><div class="label">引用依據</div>${refsHtml}</div>`;
      }
    }
    // --- Built-in program rationale list ---
    const progListEl=$('#science-acsm-program-list');
    const progCountEl=$('#science-acsm-program-count');
    if(progListEl){
      const allPrograms=(typeof PS!=='undefined'&&Array.isArray(PS.bi))?PS.bi:[];
      const rows=allPrograms.map(pr=>{const pm=Knowledge.getProgramMetadata(pr.id);return pm?{pr,pm}:null;}).filter(Boolean);
      if(progCountEl)progCountEl.textContent=rows.length?`${rows.length} 筆`:'—';
      if(!rows.length){progListEl.innerHTML='<div class="empty">尚未有內建 ACSM 課表依據</div>';}
      else{
        progListEl.innerHTML=rows.map(({pr,pm})=>{
          const nm=Utils.escape(pr.name||pr.id||'');
          const st=Utils.escape(pm.split_type||'—');
          const pg=Utils.escape(pm.primary_goal||'—');
          const fr=Utils.escape(pm.frequency_recommendation||'—');
          const dur=Array.isArray(pm.duration_range)&&pm.duration_range.length===2?`${pm.duration_range[0]}–${pm.duration_range[1]} 分`:'—';
          const vol=Utils.escape(pm.volume_profile||'—');
          const fp=Utils.escape(pm.fatigue_profile||'—');
          const tp=(Array.isArray(pm.target_population)?pm.target_population:[]).map(x=>`<span class="pill">${Utils.escape(x)}</span>`).join('')||'—';
          const rs=Utils.escape(pm.rationale_summary||'');
          const evCount=Array.isArray(pm.evidence_ref_ids)?pm.evidence_ref_ids.length:0;
          const evPill=evCount?`<span class="pill pill-evidence">ACSM 依據 ${evCount} 筆</span>`:'';
          return`<div class="item acsm-program-row"><div style="min-width:0"><h3>${nm}</h3><div class="meta"><span>${st}</span><span>${pg}</span><span>${fr}</span><span>${dur}</span>${evPill}</div><div class="acsm-program-rationale">${rs}</div><div class="acsm-kv-grid acsm-kv-grid-compact"><div class="science-kv"><div class="label">量能</div><div class="value">${vol}</div></div><div class="science-kv"><div class="label">疲勞</div><div class="value">${fp}</div></div><div class="science-kv"><div class="label">目標族群</div><div class="chip-row">${tp}</div></div></div></div></div>`;
        }).join('');
      }
    }
    // --- Evidence references list ---
    const evListEl=$('#science-acsm-evidence-list');
    const evCountEl=$('#science-acsm-evidence-count');
    if(evListEl){
      const refs=Knowledge.listEvidenceRefs();
      if(evCountEl)evCountEl.textContent=refs.length?`${refs.length} 筆`:'—';
      if(!refs.length){evListEl.innerHTML='<div class="empty">尚未載入文獻來源</div>';}
      else{
        evListEl.innerHTML=refs.map(r=>{
          const src=Utils.escape(r.source||'');
          const yr=Utils.escape(String(r.year||''));
          const ti=Utils.escape(r.title||'');
          const sm=Utils.escape(r.summary||'');
          const tags=(Array.isArray(r.tags)?r.tags:[]).map(t=>`<span class="pill">${Utils.escape(t)}</span>`).join('');
          return`<div class="item acsm-evidence-row"><div style="min-width:0"><h3>${ti}</h3><div class="meta"><span>${src}</span><span>${yr}</span></div><div class="acsm-evidence-summary">${sm}</div>${tags?`<div class="chip-row" style="margin-top:6px">${tags}</div>`:''}</div></div>`;
        }).join('');
      }
    }
  },
...
function handleAction(action,el){
  switch(action){
    ...
    case 'delete-session':{const sid=el.dataset.id;if(!sid)break;if(!confirm('確定刪除此訓練紀錄？此操作無法復原。'))break;SC.deleteSession(sid);break}
    case 'delete-current-session':{const sid=el.dataset.id||SC.detId;if(!sid)break;if(!confirm('確定刪除此訓練紀錄？此操作無法復原。'))break;SC.deleteSession(sid);Nav.go('screen-history');break}
    ...
    case 'app-set-workspace-self':App.set(WORKSPACE_SELF);break;
    case 'app-set-workspace-coach':App.set(WORKSPACE_COACH);break;
    case 'open-coach-clients':if(!App.isCoach())App.set(WORKSPACE_COACH);Nav.go('screen-coach-clients');break;
    case 'back-coach-clients':Nav.go('screen-home');break;
    ...
    case 'coach-delete-client':{const c=Clients.byId(el.dataset.id);if(!c)break;if(!confirm(`刪除學員「${c.name||'Unnamed Client'}」？其課表、課程、筆記與報告也會一併移除，且無法復原。`))break;const delId=el.dataset.id;if(Clients.delete(delId)){if(SC.coachCurrentClientId===delId)SC.coachCurrentClientId='';if(SC.coachReportsClientId===delId)SC.coachReportsClientId='';SC.renderCoachClients();Toast.show('已刪除學員')}break}
...
// ================================================================
const DEF_CDB={version:CDB_VERSION,clients:[],clientPrograms:[],clientSessions:[],clientReports:[],clientNotes:[],clientProgress:[],clientFeedback:[],settings:{defaultClientId:''}};
...
const CDB={
  ...
  migrate(d){
    ...
    ['clients','clientPrograms','clientSessions','clientReports','clientNotes','clientProgress','clientFeedback'].forEach(k=>{if(!Array.isArray(m[k]))m[k]=[]});
...
const Clients={
  ...
  delete(id){
    ...
    CDB.data.clientNotes=(CDB.data.clientNotes||[]).filter(n=>n.clientId!==id);
    CDB.data.clientProgress=(CDB.data.clientProgress||[]).filter(p=>p.clientId!==id);
    CDB.data.clientFeedback=(CDB.data.clientFeedback||[]).filter(f=>f.clientId!==id);
...
// ---- Client Coaching Module v1 · Step 2B: Coach domain skeleton (notes / progress / feedback) ----
const ClientNotes={
  _now(){return Date.now()},
  getAll(){return((CDB.data&&CDB.data.clientNotes)||[]).slice()},
  byClient(clientId){return this.getAll().filter(n=>n.clientId===clientId).sort((a,b)=>((b.updatedAt||b.createdAt||0)-(a.updatedAt||a.createdAt||0)))},
  byId(id){return this.getAll().find(n=>n.id===id)||null},
  sanitize(note){
    const src=(note&&typeof note==='object')?note:{};
    const now=this._now();
    return{
      id:Utils.text(src.id)||Utils.uid('cnote'),
      clientId:Utils.text(src.clientId),
      text:Utils.text(src.text),
      tags:Array.isArray(src.tags)?src.tags.map(t=>Utils.text(t)).filter(Boolean):[],
      createdAt:Number.isFinite(src.createdAt)?src.createdAt:now,
      updatedAt:now
    };
  ...
  save(note){
    ...
    if(!clean.clientId||!clean.text)return null;
    const list=CDB.data.clientNotes;
    const idx=list.findIndex(n=>n.id===clean.id);
    if(idx>=0)list[idx]=clean;else list.unshift(clean);
    CDB.save();
    return clean;
  },
  delete(id){
    if(!CDB.data)return false;
    const before=CDB.data.clientNotes.length;
    CDB.data.clientNotes=CDB.data.clientNotes.filter(n=>n.id!==id);
    CDB.save();
    return CDB.data.clientNotes.length<before;
  }
};

const ClientProgress={
  _now(){return Date.now()},
  getAll(){return((CDB.data&&CDB.data.clientProgress)||[]).slice()},
  byClient(clientId){return this.getAll().filter(p=>p.clientId===clientId).sort((a,b)=>((b.createdAt||0)-(a.createdAt||0)))}
};
...
SC.renderCoachClientCard=function(c){
  ...
  const isCurrent=(SC.coachCurrentClientId||'')===c.id;
  ...
  const pills=[];
  if(isCurrent)pills.push('<span class="client-pill current">目前選擇</span>');
  ...
  const primary=[];
  primary.push(`<button class="btn primary" data-action="open-coach-client-detail" data-id="${c.id}">進入工作區</button>`);
  primary.push(`<button class="btn" data-action="open-coach-programs" data-id="${c.id}">課表</button>`);
...
// ---- Client Coaching Module v1 · Step 2C (Phase 4): Client Detail Workspace ----
SC.openCoachClientDetail=function(clientId){
  const id=clientId||'';
  if(!id){Toast.show('請先選擇學員');return}
  const c=Clients.byId(id);
  if(!c){Toast.show('找不到該學員');return}
  this.coachCurrentClientId=id;
  this.coachReportsClientId=id;
  Nav.go('screen-coach-client-detail');
};

SC.renderCoachClientDetail=function(){
  if(!CDB.data)CDB.load();
  const id=this.coachCurrentClientId||'';
  const client=id?Clients.byId(id):null;
  const nameEl=$('#coach-client-detail-name');
  const subEl=$('#coach-client-detail-sub');
  const heroEl=$('#coach-client-detail-hero');
  const goalEl=$('#coach-client-detail-goal');
  const entriesEl=$('#coach-client-detail-entries');
  const recentEl=$('#coach-client-detail-recent');
  const notesEl=$('#coach-client-detail-notes');
  const noteInput=$('#coach-client-detail-note-input');
  if(!client){
    if(nameEl)nameEl.textContent='學員';
    if(subEl)subEl.textContent='Client Workspace';
    const empty='<div class="empty">找不到此學員，可能已被刪除。請返回學員列表重新選擇。</div>';
    if(heroEl)heroEl.innerHTML=empty;
  ...
  const defaultId=(CDB.data&&CDB.data.settings&&CDB.data.settings.defaultClientId)||'';
  const isDefault=defaultId===client.id;
  const isArchived=!!client.isArchived;
  if(nameEl)nameEl.textContent=client.name||'Unnamed Client';
  if(subEl)subEl.textContent=isArchived?'已封存學員':(isDefault?'預設學員':'學員工作區');

  const stats=this.getClientStats(client.id);

  if(heroEl){
    const metaParts=[];
    if(client.gender){const gm={female:'女',male:'男',other:'其他'};metaParts.push(gm[client.gender]||client.gender)}
    if(client.age!==''&&client.age!=null)metaParts.push(`${client.age} 歲`);
    if(client.heightCm!==''&&client.heightCm!=null)metaParts.push(`${client.heightCm} cm`);
    if(client.weightKg!==''&&client.weightKg!=null)metaParts.push(`${client.weightKg} kg`);
    const metaHtml=metaParts.length?`<div class="coach-detail-hero-meta">${metaParts.map(t=>`<span>${Utils.escape(t)}</span>`).join('')}</div>`:'';
    const tagsHtml=(Array.isArray(client.tags)&&client.tags.length)?`<div class="coach-detail-hero-tags">${client.tags.map(t=>`<span>#${Utils.escape(t)}</span>`).join('')}</div>`:'';
    const noteHtml=client.note?`<div class="coach-detail-hero-note">${Utils.escape(client.note)}</div>`:'';
    const scheduleHtml=client.scheduleNote?`<div class="coach-detail-hero-note">上課：${Utils.escape(client.scheduleNote)}</div>`:'';
    const pills=[];
    if(isDefault)pills.push('<span class="client-pill default">預設</span>');
    if(isArchived)pills.push('<span class="client-pill archived">封存</span>');
    const pillsHtml=pills.length?`<div class="coach-detail-hero-pills">${pills.join('')}</div>`:'';
    heroEl.innerHTML=`<div class="coach-detail-hero-head"><h3 class="coach-detail-hero-name">${Utils.escape(client.name||'Unnamed Client')}</h3>${pillsHtml}</div>${metaHtml}${tagsHtml}${noteHtml}${scheduleHtml}<div class="coach-detail-hero-stats"><div class="kv"><div class="k">課表</div><div class="v num">${stats.programCount}</div></div><div class="kv"><div class="k">課程</div><div class="v num">${stats.sessionCount}</div></div><div class="kv"><div class="k">報告</div><div class="v num">${stats.reportCount}</div></div></div>`;
  }

  if(goalEl){
    const goalText=client.goal?Utils.escape(client.goal):'<span class="subtle">尚未設定目標</span>';
    goalEl.innerHTML=`<div class="coach-detail-goal-title">訓練目標</div><div class="coach-detail-goal-text">${goalText}</div>`;
  }
  ...
  if(recentEl){
    const recent=Workspace.coachRecentByClient(client.id,5);
    if(!recent.length){recentEl.innerHTML='<div class="empty">尚無課程紀錄。完成一次教練訓練後會顯示在這裡。</div>'}
    else{
  ...
  if(notesEl){
    ...
    if(!notes.length){notesEl.innerHTML='<div class="empty">尚未留下教練筆記。新增第一則筆記記錄你對這位學員的觀察與計畫。</div>'}
    else{
      notesEl.innerHTML=notes.map(n=>{
        const ts=n.updatedAt||n.createdAt||0;
        const tsText=ts?Utils.formatDateTime(ts):'';
        return `<div class="coach-note-item"><div class="coach-note-item-text">${Utils.escape(n.text||'')}</div><div class="coach-note-item-foot"><span class="coach-note-item-time">${Utils.escape(tsText)}</span><button class="btn btn-sub danger" data-action="coach-client-note-delete" data-id="${Utils.escape(n.id)}">刪除</button></div></div>`;
      }).join('');
    }
  }
...
SC.renderCoachFeedbackItem=function(f){
  ...
  // V5.1.1: rule-based ACSM risk hint — no analyzer call, purely from feedback values.
  const riskBits=[];
  if(Number(f.fatigue)>=8)riskBits.push(`高疲勞 ${f.fatigue}/10，建議安排恢復日`);
  if(f.pain&&String(f.pain).trim())riskBits.push('含疼痛／不適回報，確認動作安全性');
  if(f.nutrition!==''&&f.nutrition!=null&&Number(f.nutrition)<=2)riskBits.push(`飲食不足 ${f.nutrition}/5，提醒補充恢復`);
  const riskHtml=riskBits.length?`<div class="coach-fb-risk-hint">${riskBits.map(r=>`<span class="coach-fb-risk-bit">${Utils.escape(r)}</span>`).join('')}</div>`:'';
  return `<div class="coach-fb-item" data-id="${Utils.escape(f.id)}"><div class="coach-fb-head"><div class="coach-fb-title"><strong>${Utils.escape(d)}</strong>${pillsHtml}</div><button class="btn btn-sub" data-action="coach-edit-feedback" data-id="${Utils.escape(f.id)}">編輯</button></div><div class="meta">${meta}</div>${riskHtml}${noteHtml}<div class="coach-fb-foot">${f.viewed?'<button class="btn btn-sub" data-action="coach-feedback-mark-viewed" data-id="'+Utils.escape(f.id)+'" data-viewed="0">標記未讀</button>':'<button class="btn btn-sub" data-action="coach-feedback-mark-viewed" data-id="'+Utils.escape(f.id)+'" data-viewed="1">標記已讀</button>'}<button class="btn btn-sub" data-action="coach-feedback-toggle-followup" data-id="${Utils.escape(f.id)}">${f.followUp?'取消追蹤':'加入追蹤'}</button><button class="btn btn-sub" data-action="coach-feedback-jump-client" data-id="${Utils.escape(f.clientId||'')}">前往學員</button></div></div>`;
};
...
SC.saveCoachClientNoteFromInput=function(){
  const id=this.coachCurrentClientId||'';
  if(!id){Toast.show('請先選擇學員');return}
  const input=$('#coach-client-detail-note-input');
  const text=Utils.text(input?input.value:'');
  if(!text){Toast.show('請輸入筆記內容');return}
  const saved=ClientNotes.save({clientId:id,text});
  if(!saved){Toast.show('儲存失敗');return}
  if(input)input.value='';
  this.renderCoachClientDetail();
  Toast.show('已新增筆記');
};

SC.deleteCoachClientNote=function(noteId){
  if(!noteId)return;
  if(!confirm('刪除這則筆記？'))return;
  if(ClientNotes.delete(noteId)){
    this.renderCoachClientDetail();
    Toast.show('已刪除筆記');
  }
};

SC.startCoachSessionForClient=function(clientId){
  const id=clientId||this.coachCurrentClientId||'';
  if(!id){Toast.show('請先選擇學員');return}
  this.coachCurrentClientId=id;
  const active=(typeof this.getCoachActiveProgram==='function')?this.getCoachActiveProgram(id):null;
  if(!active){
    Nav.go('screen-coach-programs');
    Toast.show('此學員尚未設定使用中課表，請先選擇課表。');
    return;
  }
  if(CWK.session){
    const sameClient=CWK.session.clientId===id;
    const sameProgram=CWK.session.programId===active.id;
    if(!sameClient||!sameProgram){
      if(!confirm('目前已有其他未完成的教練訓練，繼續將捨棄現有草稿。要開始新的訓練嗎？'))return;
      CWK.discard();
      CWK.start(id,{programId:active.id});
    }
  }else{
    CWK.start(id,{programId:active.id});
  }
...
// ================================================================
// 19.5 V5 DATA NAMESPACE — workspace accessors + knowledge layer
// ----------------------------------------------------------------
// Phase 1 skeleton. Explicit getters for (a) the shared knowledge
// layer and (b) the two isolated workspace data pools. Underlying
// containers (DB / WK / CDB / CWK / EXERCISE_REGISTRY / PS.bi /
// MOVEMENT_PATTERN_MAP) remain untouched. Later phases should use
// these getters instead of direct DB.data.* / CDB.data.* access so
// workspace ownership is explicit at every call site.
// ================================================================
...
const Workspace={
  shared(){return Knowledge},

  // Self pool getters (V4.1.0 data continues to live in DB / WK)
  selfRoot(){return DB},
  selfProgramInstances(){return DB.data.programs},
  selfSessions(){return DB.data.workouts},
  selfHistory(){return DB.data.workouts},
  selfReportsDaily(){return DB.data.dailyReports},
  selfReportsWeekly(){return DB.data.weeklyReports},
  selfWeight(){return DB.data.weightEntries},
  selfCardio(){return DB.data.cardioEntries},
  selfSettings(){return DB.data.settings},
  selfDraft(){return WK.session},
  selfSummary(){return WK.summary},
  // session_items are the exercise rows inside each stored session.
  // V4.1.0 keeps them embedded under session.exercises[].sets[]; this
  // getter is reserved as a future flattened pool.
  selfSessionItems(){return null},
  selfRecent(){return []},           // reserved; Phase 4+ implements
  selfFavorites(){return []},        // reserved; Phase 4+ implements
  selfProgressMetrics(){return []},  // reserved; Phase 6+ implements

  // Coach pool getters (CDB / CWK, fully isolated from self)
  coachRoot(){return CDB},
  coachClients(){return CDB.data.clients},
  coachClientProfiles(){return CDB.data.clients},  // Phase 4 may split profiles out
  coachProgramInstances(){return CDB.data.clientPrograms},
  coachSessions(){return CDB.data.clientSessions},
  coachReports(){return CDB.data.clientReports},
  coachSettings(){return CDB.data.settings},
  coachDraft(){return CWK.session},
  coachSummary(){return CWK.summary},
  coachSessionItems(){return null},  // reserved flattened pool (see selfSessionItems)
  coachRecent(){
    const sessions=(CDB.data&&Array.isArray(CDB.data.clientSessions))?CDB.data.clientSessions:[];
    return sessions.slice().sort((a,b)=>((b.finishedAt||b.startedAt||0)-(a.finishedAt||a.startedAt||0)));
  },
  coachRecentByClient(clientId,limit){
    if(!clientId)return[];
    const all=this.coachRecent().filter(s=>s&&s.clientId===clientId);
  ...
  coachNotesByClient(clientId){
    if(!clientId)return[];
    return this.coachNotes().filter(n=>n&&n.clientId===clientId)
...
// 20. BOOTSTRAP
// ================================================================
function init(){App.load();DB.load();bindEvents();WK.loadDraft();if(WK.session)WK.restoreIfNeeded();Knowledge.init();SC.init();if(WK.session)SC.renderWorkout();initCoachingDomain()}
